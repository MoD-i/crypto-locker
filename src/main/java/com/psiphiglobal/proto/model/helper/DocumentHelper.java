...
public final class DocumentHelper
{
    public static boolean validate(Document document)
    {
        return !(document.getName() == null || document.getName().isEmpty() ||
                document.getCreator() == null || document.getCreator().isEmpty() ||
                document.getEncryptedContent() == null || document.getEncryptedContent().isEmpty() ||
                document.getSignature() == null || document.getSignature().isEmpty());
    }
